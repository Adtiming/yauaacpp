...
public:
  ...
  explicit UserAgentParser(antlr4::TokenStream *input);

  UserAgentParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~UserAgentParser() override;
